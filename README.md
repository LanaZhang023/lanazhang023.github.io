...
Automated clinical trial reporting in SAS for 11,000+ patients using CDISC-compliant pipeline, building SDTM and ADaM datasets, applying macro-based summary tables (%tablen), and generating stratified visualizations (PROC TTEST & SGPLOT). Final report automated as a publication-ready PDF with narrative interpretation of baseline comparability and adverse event profiles, supporting downstream clinical decision-making.
